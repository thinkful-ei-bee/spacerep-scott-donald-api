      ...
      it(`responds with incorrect and moves head`, () => {
        return supertest(app)
          ...
          .expect({
            ...
            wordIncorrectCount: 0,
            answer: { 
              correct: testLanguagesWords[0].translation, 
              example: testLanguagesWords[0].example, 
              name: testLanguagesWords[0].name
            },
            isCorrect: false
          })
      })
      ...
      it(`moves the word 1 space and updates incorrect count`, async () => {
        ...
        await supertest(app)
          ...
          .expect({
            ...
            answer: { 
              correct: testLanguagesWords[1].translation, 
              example: testLanguagesWords[1].example, 
              name: testLanguagesWords[1].name
            },
            isCorrect: false
          })
      })
      ...
      it(`moves the word 2 spaces, increases score and correct count`, async () => {
        ...
        await supertest(app)
          ...
          .expect({
            ...
            wordIncorrectCount: 0,
            answer: { 
              correct: testLanguagesWords[2].translation, 
              example: testLanguagesWords[2].example, 
              name: testLanguagesWords[2].name
            },
            isCorrect: true
          })
      })
